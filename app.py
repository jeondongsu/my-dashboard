...
with tab1:
    ...
    region_codes = {
        ...
        "41173": "경기도 안양시 동안구", "41190": "경기도 부천시", "41210": "경기도 광명시",
        ...
        "28720": "인천광역시 옹진군",
        "36110": "세종특별자치시",
        "42110": "강원도 춘천시", "42130": "강원도 원주시", "42150": "강원도 강릉시",
        "42170": "강원도 동해시", "42190": "강원도 태백시", "42210": "강원도 속초시",
        "42230": "강원도 삼척시", "42720": "강원도 홍천군", "42730": "강원도 횡성군",
        "42750": "강원도 영월군", "42760": "강원도 평창군", "42770": "강원도 정선군",
        "42780": "강원도 철원군", "42790": "강원도 화천군", "42800": "강원도 양구군",
        "42810": "강원도 인제군", "42820": "강원도 고성군", "42830": "강원도 양양군",
        "43110": "충청북도 청주시", "43111": "충청북도 청주시 상당구", "43112": "충청북도 청주시 서원구",
        "43113": "충청북도 청주시 흥덕구", "43114": "충청북도 청주시 청원구", "43130": "충청북도 충주시",
        "43150": "충청북도 제천시", "43720": "충청북도 보은군", "43730": "충청북도 옥천군",
        "43740": "충청북도 영동군", "43745": "충청북도 증평군", "43750": "충청북도 진천군",
        "43760": "충청북도 괴산군", "43770": "충청북도 음성군", "43800": "충청북도 단양군",
        "44130": "충청남도 천안시", "44131": "충청남도 천안시 동남구", "44133": "충청남도 천안시 서북구",
        "44150": "충청남도 공주시", "44180": "충청남도 보령시", "44200": "충청남도 아산시",
        "44210": "충청남도 서산시", "44230": "충청남도 논산시", "44250": "충청남도 계룡시",
        "44270": "충청남도 당진시", "44710": "충청남도 금산군", "44760": "충청남도 부여군",
        "44770": "충청남도 서천군", "44790": "충청남도 청양군", "44800": "충청남도 홍성군",
        "44810": "충청남도 예산군", "44825": "충청남도 태안군",
        "30110": "대전광역시 동구", "30140": "대전광역시 중구", "30170": "대전광역시 서구",
        "30200": "대전광역시 유성구", "30230": "대전광역시 대덕구",
        "45110": "전라북도 전주시", "45111": "전라북도 전주시 완산구", "45113": "전라북도 전주시 덕진구",
        "45130": "전라북도 군산시", "45140": "전라북도 익산시", "45180": "전라북도 정읍시",
        "45190": "전라북도 남원시", "45210": "전라북도 김제시", "45710": "전라북도 완주군",
        "45720": "전라북도 진안군", "45730": "전라북도 무주군", "45740": "전라북도 장수군",
        "45750": "전라북도 임실군", "45770": "전라북도 순창군", "45790": "전라북도 고창군",
        "45800": "전라북도 부안군",
        ...
        "47110": "경상북도 포항시", "47111": "경상북도 포항시 남구", "47113": "경상북도 포항시 북구",
        "47130": "경상북도 경주시", "47150": "경상북도 김천시", "47170": "경상북도 안동시",
        "47190": "경상북도 구미시", "47210": "경상북도 영주시", "47230": "경상북도 영천시",
        "47250": "경상북도 상주시", "47280": "경상북도 문경시", "47290": "경상북도 경산시",
        "47720": "경상북도 군위군", "47730": "경상북도 의성군", "47750": "경상북도 청송군",
        "47760": "경상북도 영양군", "47770": "경상북도 영덕군", "47820": "경상북도 청도군",
        "47830": "경상북도 고령군", "47840": "경상북도 성주군", "47850": "경상북도 칠곡군",
        "47900": "경상북도 예천군", "47920": "경상북도 봉화군", "47930": "경상북도 울진군",
        "47940": "경상북도 울릉군",
        ...
        "48120": "경상남도 창원시", "48121": "경상남도 창원시 의창구", "48123": "경상남도 창원시 성산구",
        "48125": "경상남도 창원시 마산합포구", "48127": "경상남도 창원시 마산회원구", "48129": "경상남도 창원시 진해구",
        "48170": "경상남도 진주시", "48220": "경상남도 통영시", "48240": "경상남도 사천시",
        "48250": "경상남도 김해시", "48270": "경상남도 밀양시", "48310": "경상남도 거제시",
        "48330": "경상남도 양산시", "48720": "경상남도 의령군", "48730": "경상남도 함안군",
        "48740": "경상남도 창녕군", "48820": "경상남도 고성군", "48840": "경상남도 남해군",
        "48850": "경상남도 하동군", "48860": "경상남도 산청군", "48870": "경상남도 함양군",
    ...
    if st.checkbox("🔄 24시간 무인 자동 감시 작동 - 1분마다"):
        ...
        if is_weekday and is_market_hours:
            ...
            if dw_price > 0 and dw_price <= dw_buy_target and not st.session_state.dw_buy_fired:
                msg = f"📉 [대우건설 매수 경보] 목표가 진입: {dw_price:,}원"
            ...
            if dw_price > 0 and dw_price >= dw_sell_target and not st.session_state.dw_sell_fired:
                msg = f"📈 [대우건설 매도 경보] 목표가 돌파: {dw_price:,}원"
                requests.post(f"https://api.telegram.org/bot{TG_TOKEN}/sendMessage", data={"chat_id": TG_CHAT_ID, "text": msg})
            ...
            if space_price > 0 and space_price <= space_buy_target and not st.session_state.space_buy_fired:
                msg = f"📉 [우주테크 ETF 매수 경보] 목표가 진입: {space_price:,}원"
                requests.post(f"https://api.telegram.org/bot{TG_TOKEN}/sendMessage", data={"chat_id": TG_CHAT_ID, "text": msg})
            ...
            if space_price > 0 and space_price >= space_sell_target and not st.session_state.space_sell_fired:
                msg = f"📈 [우주테크 ETF 매도 경보] 목표가 돌파: {space_price:,}원"
                requests.post(f"https://api.telegram.org/bot{TG_TOKEN}/sendMessage", data={"chat_id": TG_CHAT_ID, "text": msg})
            ...
            if eth_price > 0 and eth_price <= eth_buy_target and not st.session_state.eth_buy_fired:
                msg = f"💎📉 [이더리움 매수 경보] 목표가 진입: {eth_price:,}원"
                requests.post(f"https://api.telegram.org/bot{TG_TOKEN}/sendMessage", data={"chat_id": TG_CHAT_ID, "text": msg})
            ...
            if eth_price > 0 and eth_price >= eth_sell_target and not st.session_state.eth_sell_fired:
                msg = f"💎📈 [이더리움 매도 경보] 목표가 돌파: {eth_price:,}원"
                requests.post(f"https://api.telegram.org/bot{TG_TOKEN}/sendMessage", data={"chat_id": TG_CHAT_ID, "text": msg})
            ...
            if sk_price > 0 and sk_price <= sk_buy_target and not st.session_state.sk_buy_fired:
                ...
                requests.post(f"https://api.telegram.org/bot{TG_TOKEN}/sendMessage", data={"chat_id": TG_CHAT_ID, "text": msg})
                st.session_state.sk_buy_fired = True
                st.session_state.alert_logs.insert(0, f"[{log_time}] {msg}")
            if sk_price > sk_buy_target: st.session_state.sk_buy_fired = False

            if sk_price > 0 and sk_price >= sk_sell_target and not st.session_state.sk_sell_fired:
                msg = f"🌐📈 [SK네트웍스 매도 경보] 목표가 돌파: {sk_price:,}원"
                requests.post(f"https://api.telegram.org/bot{TG_TOKEN}/sendMessage", data={"chat_id": TG_CHAT_ID, "text": msg})
